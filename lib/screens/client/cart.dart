              ...
              return Dismissible(
                  ...
                  onDismissed: (direction) async {
                    ...
                    if (direction == DismissDirection.startToEnd ||
                      ...
                      await FloorFactory.getMyProductsDb().then((value) => value
                          .myProductsDao
                          .deleteProductById(product.productId, userId));
                      setState(() {
                        ...
                        action: SnackBarAction(
                          ...
                          onPressed: () async {
                            await FloorFactory.getMyProductsDb().then((value) =>
                                value.myProductsDao.insertProduct(product));
                            setState(() {
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Image(
                            image: NetworkImage(
                                myProducts[index].image.toString()),
                            width: 100,
                            height: 140,
                            fit: BoxFit.fill,
                          ),
                            ...
                            children: [
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      color: HexColor("#F0F3F4"), fontSize: 20),
                                  maxLines: 1,
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      color: HexColor("#ECF0F1"), fontSize: 17),
                                  maxLines: 1,
